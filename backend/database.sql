-- SCRIPT DE BASE DE DATOS: SGD CORAZA (PostgreSQL)
-- Creación de tablas, índices y precarga de datos normativos (TRD, Usuarios)
...
-- 11. TABLA DE RETENCION DOCUMENTAL (TRD)
...
-- INDICES PARA OPTIMIZAR BÚSQUEDAS (ELIMINA LENTITUD)
...
CREATE INDEX IF NOT EXISTS idx_contratos_num ON contratos(numero_contracto);
...
-- SEMILLAS / DATOS INICIALES TRD DE LEY (AGN)
...
('TRD-001', '100', 'GERENCIA GENERAL', '10', 'COMUNICACIONES OFICIALES', '01', 'CARTAS Y MEMORANDOS', 2, 8, 'CONSERVACION TOTAL', 'Código de Comercio Art. 60 / Ley 594'),
('TRD-002', '200', 'GESTION HUMANA', '20', 'HISTORIAS LABORALES Y SG-SST', '01', 'EXAMENES MEDICOS Y SALUD OCUPACIONAL', 5, 15, 'CONSERVACION TOTAL (20 AÑOS)', 'Decreto 1072 de 2015 SG-SST'),
...
('TRD-005', '500', 'JURIDICA Y CONTRATOS', '50', 'CONTRATOS Y CONVENIOS', '01', 'CONTRATOS COMERCIALES Y LABORALES', 5, 15, 'CONSERVACION TOTAL', 'Ley 80 / Código de Comercio')
ON CONFLICT (id) DO NOTHING;

-- SEMILLA DE USUARIO ADMINISTRADOR POR DEFECTO
-- Contraseña por defecto: Admin123 (hash encriptado con bcrypt)
